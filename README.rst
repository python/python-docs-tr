...
- Or just by opening `an issue on github <https://github.com/python/python-docs-trfr/issues>`_
...
You'll need to fork the `python-docs-tr
<https://github.com/python/python-docs-tr>`_ clicking its ``Fork``
...
.. code-block:: bash
    ...
    git clone git@github.com:JulienPalard/python-docs-tr.git

    # Go to the cloned directory:
    cd python-docs-tr/

    # Add the upstream (the public repository) using HTTPS (won't ask for password):
    git remote add upstream https://github.com/python/python-docs-tr.git
...
.. code-block:: bash
    ...
    # https://github.com/python/python-docs-tr/ and a nice "Compare & pull request"
...
All those snippets are to run from the root of a ``python-docs-tr``
